...
public class TelaController implements Initializable {
	...
	private void adicionarOngs(ActionEvent event) {
		loadWindow("/br/com/ueg/doacao/view/ongs/TelaCadastro.fxml", "Cadastro de Ongs");

	}

	@FXML
	private void abrirRelatorio1(ActionEvent event) {
		loadWindow("/br/com/ueg/doacao/view/relatorios/Relatorio.fxml", "Relatório Igu Igu");
	}
	...
	private void adicionarUsuario(ActionEvent event) {
		loadWindow("/br/com/ueg/doacao/view/users/Users.fxml", "Cadastro de Usuários");
	}
